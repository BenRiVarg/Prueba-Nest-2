...
<!-- Mirrored from jaybabani.com/ultra-admin-html/preview/ui-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 29 Aug 2019 18:41:22 GMT -->
<head>
        <!-- 
                ...
                <form name="loginform" id="loginform" action="{{ route('login') }}" method="post">
                    <p>
                        <label for="user_login">Username<br />
                            <input type="email"  id="user_login" class="input" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus size="20" /></label>
                            @error('email')
                    ...
                    <p>
                        <label for="user_pass">Password<br />
                            <input type="password"  id="user_pass" class="input" name="password" required autocomplete="current-password" size="20" /></label>
                            @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                    ...
                    <p class="forgetmenot">
                        <label class="icheck-label form-label" for="rememberme"><input name="rememberme" type="checkbox" id="rememberme" value="forever" class="skin-square-orange" {{ old('remember') ? 'checked' : '' }}> Remember me</label>
                    </p>
...
<!-- Mirrored from jaybabani.com/ultra-admin-html/preview/ui-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 29 Aug 2019 18:41:24 GMT -->
</html>
